...
namespace Core3lb
{
    ...
    //PlayerRigBase.PlayerInput().GetInputBool(PlayerRigBase.PlayerInput().handTrigger, Input3lb.Controller.Left,Input3lb.InputRequest.Get);
        ...
        public class InputXR : MonoBehaviour
        {
            ...
            [CoreToggleHeader("Custom Inputs")]
            public bool showCustomInputs;
            [CoreShowIf("showCustomInputs")]
            public InputReferencesXR custom1;
            [CoreShowIf("showCustomInputs")]
            public InputReferencesXR custom2;
            [CoreShowIf("showCustomInputs")]
            public InputReferencesXR custom3;
            [CoreShowIf("showCustomInputs")]
            public InputReferencesXR custom4;
        public void Awake()
            {
                if(instance != null)
                {
                    Debug.LogError("Two InputXR's detected deleting this one".ToColor(), gameObject);
                    Destroy(this);
                }
                instance = this;
                if(inputOverride)
                {
                    ...
                    {
                        Debug.LogError("Slotted Override Input is not an IOverrideInput".ToColor(), gameObject);
                    }
                }              
            }
        ...
        public virtual bool GetCustom1(Controller which)
        {
            if (overrideInputOverrideInput?.IenableOverride == true)
                return overrideInputOverrideInput.GetMenu(which);
            return HandleReference(menu, which, InputRequest.Get);
        ...
        public virtual bool GetCustom2(Controller which)
        {
            if (overrideInputOverrideInput?.IenableOverride == true)
                return overrideInputOverrideInput.GetMenu(which);
            return HandleReference(menu, which, InputRequest.Get);
        ...
        public virtual bool GetCustom3(Controller which)
        {
            if (overrideInputOverrideInput?.IenableOverride == true)
                return overrideInputOverrideInput.GetMenu(which);
            return HandleReference(menu, which, InputRequest.Get);
        ...
        public virtual bool GetCustom4(Controller which)
        {
            if (overrideInputOverrideInput?.IenableOverride == true)
                return overrideInputOverrideInput.GetMenu(which);
            return HandleReference(menu, which, InputRequest.Get);
        ...
        {
            return ButtonRequest(button, which, InputRequest.Get);
        }
