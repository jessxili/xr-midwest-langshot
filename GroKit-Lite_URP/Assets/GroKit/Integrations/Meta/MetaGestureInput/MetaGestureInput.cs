...
namespace Core3lb
{
    ...
    public class MetaGestureInput : Singleton<MetaGestureInput>, IOverrideInput
    {
        ...
        public GestureType custom1 = GestureType.Custom1;
        [CoreShowIf("showCustomInputs")]
        public GestureType custom2 = GestureType.Custom2;
        [CoreShowIf("showCustomInputs")]
        public GestureType custom3 = GestureType.Custom3;
        [CoreShowIf("showCustomInputs")]
        public GestureType custom4 = GestureType.Custom4;
        ...
        protected virtual bool GetGesture(MetaInputBridge whichBridge, GestureType eGesture)
        {
            switch (eGesture)
            {
                ...
                case GestureType.Custom1:
                    return whichBridge.custom1;
                case GestureType.Custom2:
                    return whichBridge.custom2;
                case GestureType.Custom3:
                    return whichBridge.custom3;
                case GestureType.Custom4:
                    return whichBridge.custom4;
            }
            return false;
        }
        ...
        public bool GetCustom1(InputXR.Controller selectedHand)
        {
            return GetInput(selectedHand, custom1);
        }
        public bool GetCustom2(InputXR.Controller selectedHand)
        {
            return GetInput(selectedHand, custom2);
        }
        public bool GetCustom3(InputXR.Controller selectedHand)
        {
            return GetInput(selectedHand, custom2);
        }
        public bool GetCustom4(InputXR.Controller selectedHand)
        {
            return GetInput(selectedHand, custom3);
        }
